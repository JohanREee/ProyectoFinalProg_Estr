...
void mostrarTodosLotesDeProducto(lista_Producto *lista_producto)
{
    ...
    int op;
    gotoxy(2,6); std::cout << "\tADVERTENCIA. ¿Deseas mostrar los lotes anulados por el sistema?.\n";
    verificarModificacionEnProducto(op);
...
void modificarLoteDeProducto(lista_Producto *&lista_producto)
{
    ...
    pausarYLimpiar();
    marco();
    gotoxy(2,6); std::cout << "\tSeleccione el campo del lote " << lote_actual->lote.id_lote << " que desea modificar: \n";
